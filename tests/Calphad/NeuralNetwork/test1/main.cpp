...
int main(int argc, char* argv[]) {
  ...
  Problem<DiffusionOperator<FECollection, DIM>, VARS, PST> interdiffu_problem_o(
      "Interdiffusion O", interdiffu_oper_o, xo_vars, {coef_inter}, interdiffu_pst, calphad_outputs,
      MO, heat_vars);
  ...
  Problem<DiffusionOperator<FECollection, DIM>, VARS, PST> interdiffu_problem_u(
      "Interdiffusion U", interdiffu_oper_u, xu_vars, {coef_inter}, interdiffu_pst_u,
