...
class DoubleWell : public FunctionCoefficient {
 ...
 public:
  ...
  DoubleWell(const double prefactor) {this->prefactor_ = prefactor; };
  ~DoubleWell(){};
};
 ...
 * @return std::function<double(const std::vector<double>&,const std::vector<double>&)> 
 */
std::function<double(const std::vector<double>&,const std::vector<double>&, const int dimension)> GradientEnergy::F() {
 ...
 * @return std::function<std::vector<double>(const std::vector<double>&,const std::vector<double>&, const int dimension)> 
 */
std::function<std::vector<double>(const std::vector<double>&,const std::vector<double>&, const int dimension)> GradientEnergy::GradientF() {
 ...
 * @return std::function<std::vector<double>(const std::vector<double>&,const std::vector<double>&, const int dimension)> 
 */
std::function<std::vector<double>(const std::vector<double>&,const std::vector<double>&, const int dimension)> GradientEnergy::HessianF() {
  auto func = [&]([[maybe_unused]] const std::vector<double>& input_vector, [[maybe_unused]] const std::vector<double>&, [[maybe_unused]] const int dimension) {
