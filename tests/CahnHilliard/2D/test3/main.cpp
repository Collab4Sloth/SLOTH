 ...
 * @brief 2D square->bubble solved by Cahn-Hilliard equations
 * @version 0.1
 * @date 2025-07-04
 *
...
int main(int argc, char* argv[]) {
  ...
  auto v1 = VAR(&spatial, bcs_phi, var_name_1, Glossary::Phi, 2, phi_initial_condition);
  auto v2 = VAR(&spatial, bcs_mu, var_name_2, Glossary::Mu, 2, mu_initial_condition);
