 ...
 * @brief Test for external loading f = (x,t)
 * @version 0.1
 * @date 2025-11-28
 *
...
int main(int argc, char* argv[]) {
  ...
  //     Boundary conditions     //
  // ##############################
  auto boundaries = {Boundary("upper", 0, "Neumann", 0.), Boundary("left", 1, "Neumann", 0.)};
  ...
  ExternalLoadingProblem<FittedLoading, CoordinateSystem::Cartesian, VARS, PST> problem1(
