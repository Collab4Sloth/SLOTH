 ...
 * @brief Allen-Cahn problem solved in a square : assessment of iterative solvers
 * @version 0.1
 * @date 2024-12-18
 *
...
int main(int argc, char* argv[]) {
  ...
  std::vector<IterativeSolverType> vect_solver{IterativeSolverType::BICGSTAB,
                                               IterativeSolverType::GMRES, IterativeSolverType::CG,
                                               IterativeSolverType::MINRES};
  std::vector<HyprePreconditionerType> vect_precond{HyprePreconditionerType::HYPRE_SMOOTHER};
  int is = 0;
