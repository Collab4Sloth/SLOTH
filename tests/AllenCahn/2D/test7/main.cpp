...
int main(int argc, char* argv[]) {
  ...
  auto vars = VARS(VAR(&spatial, bcs, "phi", Glossary::Phi, 1, initial_condition, exact_condition));

  auto vars2 = VARS(VAR(&spatial, bcs, "c", Glossary::Phi, 1, initial_condition, exact_condition));
  // ###########################################
  // ###########################################
  //      Post-processing                     //
  // ###########################################
