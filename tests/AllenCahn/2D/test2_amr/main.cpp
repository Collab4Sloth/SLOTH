 ...
 * @brief Allen-Cahn problem solved in a 2D pellet fragment with a constant enthalpy melting (AMR version)
 * @version 0.1
 * @date 2024-08-11
 *
...
int main(int argc, char* argv[]) {
  ...
  amr.SetCriteria(/*estimator*/ &estimator, /*max_elem_error*/ 1.e-9, /*amr_max_level*/ 4,
