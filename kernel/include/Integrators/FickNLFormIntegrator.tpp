...
/**
 * @brief Construct a new FickNLFormIntegrator object.
 *
 * This constructor initializes a nonlinear form integrator for the
 * mass diffusion equation (Fick's law).
 *
 * It also sets the internal integrator name to "Fick" and defines
 ...
 */
template <class VARS>
FickNLFormIntegrator<VARS>::FickNLFormIntegrator(Geometry geometry, const double time_step,
    ...
    : DiffusionNLFormIntegrator<VARS>(geometry, time_step, u_old, aux_old, params, auxvars,
                                      coefficients) {
 ...
 *
 * This method collects the coefficients of type `GlossaryType::Diffusivity`
