...
class PrecondDSmoother : public SolverBase<mfem::DSmoother, PreconditionerType> {
 public:
  PrecondDSmoother();
  std::shared_ptr<mfem::DSmoother> create_solver(const Parameters& params) override;
 ...
 */
std::shared_ptr<mfem::DSmoother> PrecondDSmoother::create_solver(const Parameters& params) {
